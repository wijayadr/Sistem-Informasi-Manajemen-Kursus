{{-- resources/views/livewire/admin-panel/letters/secretary-index.blade.php --}}
<div class="row">
    <div class="col-lg-12">
        <div class="card" id="letterList">
            <div class="card-header border-bottom-dashed">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Verifikasi Surat - Sekretaris Desa</h5>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Detail">
                                                    <a href="{{ route('admin.letters.secretary.detail', $letter->id) }}" class="text-primary d-inline-block">
